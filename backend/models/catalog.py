          ...
          _plugin_groups=[
              ...
              orm.PluginGroup(
                  ...
                  plugins=[
                      ...
                      Notify(cfg={'s': {'condition': lambda entity, **kwargs: entity.root_entity._primary_email != None,
                                        'subject': notifications.CATALOG_PUBLISH_SUBJECT,
          ...
          _plugin_groups=[
              ...
              orm.PluginGroup(
                  ...
                  plugins=[
                      ...
                      Notify(cfg={'s': {'condition': lambda entity, **kwargs: entity.root_entity._primary_email != None,
                                        'subject': notifications.CATALOG_SUDO_SUBJECT,
