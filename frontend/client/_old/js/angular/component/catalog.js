      ...
      Endpoint.post('read', '23', {
        ...
        $scope.manage = function (catalog) {
          Catalog.update(catalog, function (entity) {
            var existing = _.findWhere($scope.catalogs, {
              'key': entity.key
            });
                ...
                var modalInstance = $modal.open({
                  ...
                  controller: function ($scope, $modalInstance, RuleEngine, $timeout) {
                    ...
                    $scope.manageProductById = function (pricetag) {
                      $scope.manageProduct(_.findWhere(this.entity._products, {
                        key: pricetag.product
                      }), function (cancel) {
                    ...
                    $scope.manageProduct = function (product, can_delete) {
                      ...
                      var find_child = function (child, entity) {
                        return _.findWhere(entity._products, {
                          key: child.key
                        });
                      };
      ...
      var make_product_scope = function () {
        ...
        return {
          ...
          'completed': function (data) {
            ...
            if (data.entity && data.entity._products) {
              var images = _.findWhere(data.entity._products, {
                key: this.child.key
              }).images;
          ...
          'getMoreProductInstances': function (singular) {
            ...
            EntityEditor.read_entity_partial(that.entity, new_read_args, function (data) {
              ...
              if (data.entity && data.entity._products) {
                var new_prod = _.findWhere(data.entity._products, {
                  key: that.child.key
                });
                if (new_prod) {
          ...
          'manageInstance': function (instance, create) {
            ...
            var find_child = function (child, entity) {
              var new_product = _.findWhere(entity._products, {
                key: $parentScope.child.key
              });
              var new_instance = _.findWhere(new_product._instances, {
                key: child.key
              });
              return new_instance;
            };
            ...
            var cfg = {
              ...
              'get_child': function () {
                var prod = _.findWhere(this.entity._products, {
                  key: $parentScope.child.key
                });
                this.child = instance;
