angular.module('app').controller('TestsCtrl', function ($scope, $modal,
  modelsMeta, modelsUtil, endpoint, errorHandling, $q) {
  ...
  sample._products.modelclass.contents.modelclass._other_contents =
    angular.copy(sample._products.modelclass.contents);
  sample._products.modelclass.contents.modelclass._other_contents.code_name =
    '_other_contents';

  sample.read_arguments.required = true;


  var fields = [sample.read_arguments, sample.name, sample.publish_date,
    sample.discontinue_date,
