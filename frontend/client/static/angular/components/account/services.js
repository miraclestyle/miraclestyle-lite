angular.module('app').run(function (modelsConfig, endpoint, $window,
  modelsEditor, modelsMeta) {

  modelsConfig(function (models) {

    $.extend(models['11'], {
      settingsModal: function (account_key) {
        var info = modelsMeta.getActionArguments(this.kind,
          'update');
        ...
        var config = {
          ...
          scope: {
            ...
            isAssociated: function (ident) {
              return $.inArray(ident.identity, this.args.disassociate) ===
                -1;
            },
