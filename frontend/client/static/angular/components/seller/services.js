  ...
  formInputTypes.SuperPluginStorageProperty = function (info) {
    ...
    var getPluginFieldOverrides = function (kind_id, field) {
      ...
      locationSpec = {
        ...
        sortFields: ['country', 'region', 'city', 'postal_code_from',
          'postal_code_to'
        ],
        beforeSave: function ($scope, info) {
          ...
          if (updated_address.region && (!updated_address._region || (
              updated_address.region !== updated_address._region.key
            ))) {
          ...
          if (updated_address.country && ((!updated_address._country) ||
              (updated_address.country !== updated_address._country.key)
            )) {
        ...
        manage: function (arg) {
          ...
          $modal.open({
            template: underscoreTemplate.get(config.ui.specifics.templateUrl ?
              config.ui.specifics.templateUrl :
            ...
            controller: function ($scope, $modalInstance,
              ...
              $scope.setNewArg = function () {
                if ($scope.info.kind !== 0 && $scope.args.kind !=
                  $scope.info.kind) {
                  arg = {
              ...
              $scope.getFormBuilder = function () {
                ...
                angular.forEach(fields, function (field) {
                  ...
                  var extra = getPluginFieldOverrides(kind,
                    field.code_name);
                  if (extra) {
