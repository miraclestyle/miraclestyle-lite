...
(function () {
    ...
    ready(function () {
        ...
        var failure = function (response) {
            ...
            modelsmetaPromise = $http.get(GLOBAL_CONFIG.api.modelsMeta),
            promises = [modelsmetaPromise];

        modelsmetaPromise.then(function () {
            // do not schedule asynchronous requests because of csrf cookie set
            promises.push($http.get(GLOBAL_CONFIG.api.endpoint.path + '?action_id=current_account&action_model=11'));
