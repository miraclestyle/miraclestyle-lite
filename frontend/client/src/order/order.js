(function () {
    ...
    function initModels(modelsMeta, modelsConfig, $sce, GLOBAL_CONFIG, $modal, modals, snackbar, $state, helpers, endpoint, $q, $filter, currentAccount, $mdSidenav, $timeout) {
                                            ...
                                            line.product.variant_signature, {
                                                ...
                                                events: {
                                                    addToCart: function (response, deleted) {
                                                        locals.updateLiveEntity.call($scope, response, {deleted: deleted});
                                                        locals.reactOnUpdate();
                                                    }
                                                }
                                            });
