angular.module('ui.bootstrap.datetimepicker', ["ui.bootstrap"])
    .directive('datetimepicker', ['datepickerPopupConfig', 'dateFilter',
        function (datepickerPopupConfig, dateFilter) {
            'use strict';
            ...
            return {
                ...
                template: function (elem, attrs) {
                    ...
                    var tmpl = "<div class=\"datetimepicker-wrapper\">" +
                        "<input class=\"text-input date\" type=\"text\" ng-click=\"open($event)\" is-open=\"opened\" ng-model=\"ngModel\" " + [
                            ["minDate"],
                            ["maxDate"],
                            ["dayFormat"],
                            ["monthFormat"],
                ...
                link: function (scope, element, attrs, ngModel) {
                    ...
                    ngModel.$render = function () {
                        ngModel.$setViewValue(ngModel.$viewValue ? dateFilter(ngModel.$viewValue, datepickerPopupConfig.datepickerPopup) : '');
                    };
                }
            };
        }]);
