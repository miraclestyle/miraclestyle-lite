  ...
  _global_role = GlobalRole(
    permissions=[
      ...
      ActionPermission('62', Action.build_key('62', 'create').urlsafe(), False,
                       "context.entity.namespace_entity.state != 'active' or context.entity._is_system or (context.value and context.entity.key_namespace != context.value.role.entity.key_namespace)"),
