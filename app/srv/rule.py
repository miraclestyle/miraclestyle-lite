  ...
  _global_role = GlobalRole(
    permissions=[
      ActionPermission('60', Action.build_key('60', 'prepare').urlsafe(), False,
                       "not context.entities['60'].namespace_entity.state == 'active'"),
      ActionPermission('60', Action.build_key('60', 'create').urlsafe(), False,
                       "not context.entities['60'].namespace_entity.state == 'active' or context.entities['60'].key_id_str == 'admin'"),
  ...
  _plugins = [
    common.Context(
      subscriptions=[
        ...
        Action.build_key('60', 'read_records')
        ]
      ),
    common.Prepare(
      subscriptions=[
  ...
  _global_role = GlobalRole(
    permissions=[
      ActionPermission('8', Action.build_key('8', 'prepare').urlsafe(), False,
                       "not context.entities['8'].namespace_entity.state == 'active'"),
      ...
      ActionPermission('8', Action.build_key('8', 'remove').urlsafe(), False,
                       "not context.entities['8'].namespace_entity.state == 'active' or context.entities['8'].key_id_str == context.entities['8'].namespace_entity.primary_contact.entity.key_id_str"),
      ...
      ActionPermission('8', Action.build_key('8', 'accept').urlsafe(), False,
                       "not context.entities['8'].namespace_entity.state == 'active' or context.user.key_id_str != context.entities['8'].key_id_str"),
      ...
      ActionPermission('8', Action.build_key('8', 'clean_roles').urlsafe(), False,
                       "not context.entities['8'].namespace_entity.state == 'active' or not context.user._is_taskqueue"),
  ...
  _plugins = [
    common.Context(
      subscriptions=[
        ...
        Action.build_key('8', 'clean_roles')
        ]
      ),
    common.Prepare(
      subscriptions=[
